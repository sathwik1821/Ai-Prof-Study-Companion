          ...
          <form onSubmit={saveEditProject}>
            <div style={{display:'flex',flexDirection:'column',gap:14}}>
              <div className="form-group">
                ...
                <input className="input" value={editProjForm.name} onChange={e => setEditProjForm(v => ({...v, name: e.target.value}))} required autoFocus />
              </div>
              <div className="form-group">
                <label className="input-label">Description</label>
                <textarea className="input" rows={2} value={editProjForm.description} onChange={e => setEditProjForm(v => ({...v, description: e.target.value}))} />
              </div>
              <div className="form-group">
                <label className="input-label">Learning Goal</label>
                <input className="input" value={editProjForm.learningGoal} onChange={e => setEditProjForm(v => ({...v, learningGoal: e.target.value}))} placeholder="e.g. Understand backpropagation from scratch" />
              </div>
            </div>
